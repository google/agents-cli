...
description: >
  ...
  Do NOT use for deployment (use agents-cli-deploy).
metadata:
  author: Google
  license: Apache-2.0
  version: 0.0.3
...
agents-cli publish gemini-enterprise \
  --agent-engine-id projects/123456/locations/us-central1/reasoningEngines/789 \
...
agents-cli publish gemini-enterprise \
  ...
  --agent-card-url https://my-service-abc123.us-central1.run.app/a2a/app/.well-known/agent-card.json \
  --gemini-enterprise-app-id projects/123456/locations/global/collections/default_collection/engines/my-app \
...
```bash
export AGENT_ENGINE_ID="projects/123456/locations/us-central1/reasoningEngines/789"
